...
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        ...
        //remove enemy's health by subtracting the amount we set in the danage variable
    ...
    var startGame = function() {
        ...
        for (var i =0; i < enemyInfo.length; i++) {
            if (playerInfo.health > 0) {
                ...
                // pick new enemy to fight based on the indes of the enemy.names array
                var pickedEnemyObj = enemyInfo[i];

                // reset enemy.health before starting new fight
                pickedEnemyObj.health = randomNumber(40, 60);

                // pass the pickedenemy.name variable's value into the fight function, where is will assume the value of the enemy.name parameter
...
var endGame = function() {
    ...
    var highSchore = localStorage.getItem("highscore");
    if (highScore === null) {
        highScore = 0;
    }
